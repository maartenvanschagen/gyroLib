...
void test_getRegister(){
  TEST_ASSERT_EQUAL(0b11010011, I2C::getRegister(0x69, 0x0F));
}

void test_writeRegister(){
  I2C::writeRegister(0x69, 0x20, 0b00001111);
  TEST_ASSERT_EQUAL(0b00001111, I2C::getRegister(0x69, 0x20));
}

void test_writeRegister_single(){
  I2C::writeRegister(0x69, 0x20, 0b00001111);
  I2C::writeRegister(0x69, 0x20, 0b01010101, 0b00110011);
  TEST_ASSERT_EQUAL(0b00011011, I2C::getRegister(0x69, 0x20));
}
...
void test_getRegister_multiple(){
  ...
  TEST_ASSERT_EQUAL(0b00001111 << 8 | 0b11001100, list[0] << 8 | list[1]);
}
